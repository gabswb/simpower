...
import main.java.model.BuildingType;
...
/**
 * Classe principale du package main.java.controller qui permet de faire le lien entre les instances du package main.java.model et main.java.view
 * Cette classe récupère les interactions avec l'utilisateur via la vue, les traite et les transmet au main.java.model
...
public class GameController {
    ...
    private Map model;//< classe principale du main.java.model par qui passe toutes les interactions entre main.java.model et main.java.controller
     ...
     */
    public GameController() throws UnsupportedLookAndFeelException {
