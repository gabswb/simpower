...
import main.java.controller.OpenMenuListener;
...
public class InformationPanel extends JPanel implements InformationObserver {
    ...
    /**
     * Methode de l'interface Observable, qui est appeleé par le main.java.model (La Map) qui hérité de la classe abstraite observable
