...
import main.java.controller.PlaceBuildingListener;
import main.java.model.Box;
import main.java.patterns.HomeObserver;
...
public interface MapViewable extends HomeObserver {
     ...
     * @param boxes Matrice de Box du main.java.model qui contient toutes les données nécessaires pour afficher les Box correctement
     */
